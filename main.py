...
image_icon = PhotoImage(file="python.png")
...
#output code
code_output = Text(root, font="consolas 15", bg="#323846", fg="lightgreen").place(x=860,y=0,width=420, height=720 )

#button
Open = PhotoImage(file="book.png")
Save = PhotoImage(file="zori.png")
Run = PhotoImage(file="browser (1).png")
